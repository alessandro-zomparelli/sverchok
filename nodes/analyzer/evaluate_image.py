...
class svEvaluateImageNode(bpy.types.Node, SverchCustomTreeNode):
    ''' Evaluate Image '''
    bl_idname = 'SvEvaluateImageNode'
...
def register():
    bpy.utils.register_class(svEvaluateImageNode)


def unregister():
    bpy.utils.unregister_class(svEvaluateImageNode)
